...
$(document).ready(function () {
    /*RECONSTRUCTION*/
    $("div.bgReconstruction .content").css('top', 0);
    $(document).on('mouseover', 'li.reconstruction', function () {
        $('div.bgReconstruction').css({'opacity': 1, 'visibility': 'visible'});
        $("div.bgReconstruction .content").css('top', 0);
    });

    /*SKIN*/
    $(document).on('mouseover', 'li.skin', function () {
        $('div.bgSkin').css({'opacity': 1, 'visibility': 'visible'});
        $("div.bgSkin .content").css('top', 0);
        $("div.bgReconstruction .content").css('top', '100px');
    });
    $(document).on('mouseout', 'li.skin', function () {
        $('div.bgSkin').css({'opacity': 0, 'visibility': 'hidden'});
        $("div.bgSkin .content").css('top', '100px');
        $("div.bgReconstruction .content").css('top', 0);
    });

    /*SIZE*/
    $(document).on('mouseover', 'li.size', function () {
        $('div.bgSize').css({'opacity': 1, 'visibility': 'visible'});
        $("div.bgSize .content").css('top', 0);
        $("div.bgReconstruction .content").css('top', '100px');
    });
    $(document).on('mouseout', 'li.size', function () {
        $('div.bgSize').css({'opacity': 0, 'visibility': 'hidden'});
        $("div.bgSize .content").css('top', '100px');
        $("div.bgReconstruction .content").css('top', 0);
    });

    /*MOISTENING HAIR*/
    $(document).on('mouseover', 'li.moisteningHair', function () {
        $('div.bgMoisteningHair').css({'opacity': 1, 'visibility': 'visible'});
        $("div.bgMoisteningHair .content").css('top', 0);
        $("div.bgReconstruction .content").css('top', '100px');
    });
    $(document).on('mouseout', 'li.moisteningHair', function () {
        $('div.bgMoisteningHair').css({'opacity': 0, 'visibility': 'hidden'});
        $("div.bgMoisteningHair .content").css('top', '100px');
        $("div.bgReconstruction .content").css('top', 0);
    });

    /*BLOND HAIR*/
    $(document).on('mouseover', 'li.blondeHair', function () {
        $('div.bgBlondeHair').css({'opacity': 1, 'visibility': 'visible'});
        $("div.bgBlondeHair .content").css('top', 0);
        $("div.bgReconstruction .content").css('top', '100px');
    });
    $(document).on('mouseout', 'li.blondeHair', function () {
        $('div.bgBlondeHair').css({'opacity': 0, 'visibility': 'hidden'});
        $("div.bgBlondeHair .content").css('top', '100px');
        $("div.bgReconstruction .content").css('top', 0);
    });

    /*AROMA SPA*/
    $(document).on('mouseover', 'li.aromaSpa', function () {
        $('div.bgAromaSpa').css({'opacity': 1, 'visibility': 'visible'});
        $("div.bgAromaSpa .content").css('top', 0);
        $("div.bgReconstruction .content").css('top', '100px');
    });
    $(document).on('mouseout', 'li.aromaSpa', function () {
        $('div.bgAromaSpa').css({'opacity': 0, 'visibility': 'hidden'});
        $("div.bgAromaSpa .content").css('top', '100px');
        $("div.bgReconstruction .content").css('top', 0);
    });

    /*POR ART*/
    $(document).on('mouseover', 'li.porArt', function () {
        $('div.bgPorArt').css({'opacity': 1, 'visibility': 'visible'});
        $("div.bgPorArt .content").css('top', 0);
        $("div.bgReconstruction .content").css('top', '100px');
    });
    $(document).on('mouseout', 'li.porArt', function () {
        $('div.bgPorArt').css({'opacity': 0, 'visibility': 'hidden'});
        $("div.bgPorArt .content").css('top', '100px');
        $("div.bgReconstruction .content").css('top', 0);
    });

    /*BARBER*/
    $(document).on('mouseover', 'li.barber', function () {
        $('div.bgBarber').css({'opacity': 1, 'visibility': 'visible'});
        $("div.bgBarber .content").css('top', 0);
        $("div.bgReconstruction .content").css('top', '100px');
    });
    $(document).on('mouseout', 'li.barber', function () {
        $('div.bgBarber').css({'opacity': 0, 'visibility': 'hidden'});
        $("div.bgBarber .content").css('top', '100px');
        $("div.bgReconstruction .content").css('top', 0);
    });

    /*PROTOMEN*/
    $(document).on('mouseover', 'li.protomen', function () {
        $('div.bgProtomen').css({'opacity': 1, 'visibility': 'visible'});
        $("div.bgProtomen .content").css('top', 0);
        $("div.bgReconstruction .content").css('top', '100px');
    });
    $(document).on('mouseout', 'li.protomen', function () {
        $('div.bgProtomen').css({'opacity': 0, 'visibility': 'hidden'});
        $("div.bgProtomen .content").css('top', '100px');
        $("div.bgReconstruction .content").css('top', 0);
    });

    /*PROTOSKIN*/
    $(document).on('mouseover', 'li.protoskin', function () {
        $('div.bgProtoskin').css({'opacity': 1, 'visibility': 'visible'});
        $("div.bgProtoskin .content").css('top', 0);
        $("div.bgReconstruction .content").css('top', '100px');
    });
    $(document).on('mouseout', 'li.protoskin', function () {
        $('div.bgProtoskin').css({'opacity': 0, 'visibility': 'hidden'});
        $("div.bgProtoskin .content").css('top', '100px');
        $("div.bgReconstruction .content").css('top', 0);
    });
});
